...
METADATA.NAME.PURCHASE_DB = 'PurchaseDB';
...
METADATA.ADDRESS.PURCHASE_DB = go(METADATA.NAME.PURCHASE_DB, deployedFileReader, a => a.address);
...
METADATA.ABI.PURCHASE_DB = go(METADATA.NAME.PURCHASE_DB, deployedFileReader, a => a.abi);
